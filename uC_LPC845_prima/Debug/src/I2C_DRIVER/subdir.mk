...
CPP_SRCS += \
../src/I2C_DRIVER/i2c.cpp 

CPP_DEPS += \
./src/I2C_DRIVER/i2c.d 

OBJS += \
./src/I2C_DRIVER/i2c.o 


# Each subdirectory must supply rules for building sources it contributes
src/I2C_DRIVER/%.o: ../src/I2C_DRIVER/%.cpp src/I2C_DRIVER/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-I2C_DRIVER

clean-src-2f-I2C_DRIVER:
	-$(RM) ./src/I2C_DRIVER/i2c.d ./src/I2C_DRIVER/i2c.o

.PHONY: clean-src-2f-I2C_DRIVER
