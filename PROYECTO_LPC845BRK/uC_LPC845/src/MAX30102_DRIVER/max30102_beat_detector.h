...
#define BEATDETECTOR_INIT_HOLDOFF					4000	// 1
#define BEATDETECTOR_MASKING_HOLDOFF				200		// 2
#define BEATDETECTOR_BPFILTER_ALPHA					60 //0.6f	// 3
#define BEATDETECTOR_MIN_THRESHOLD					100000//100.0f	// 4
#define BEATDETECTOR_MAX_THRESHOLD					5000000//8000.0f // 5
#define BEATDETECTOR_STEP_RESILIENCY				30000//30.0f   // 6
#define BEATDETECTOR_THRESHOLD_FALLOFF_TARGET		10 //0.3f	// 7
#define BEATDETECTOR_THRESHOLD_DECAY_FACTOR			92//0.99f	// 8
#define BEATDETECTOR_INVALID_READOUT_DELAY			1000	// 9
