...
CPP_SRCS += \
../src/TIMER_DRIVER/TIMER.cpp 

CPP_DEPS += \
./src/TIMER_DRIVER/TIMER.d 

OBJS += \
./src/TIMER_DRIVER/TIMER.o 


# Each subdirectory must supply rules for building sources it contributes
src/TIMER_DRIVER/%.o: ../src/TIMER_DRIVER/%.cpp src/TIMER_DRIVER/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-TIMER_DRIVER

clean-src-2f-TIMER_DRIVER:
	-$(RM) ./src/TIMER_DRIVER/TIMER.d ./src/TIMER_DRIVER/TIMER.o

.PHONY: clean-src-2f-TIMER_DRIVER
