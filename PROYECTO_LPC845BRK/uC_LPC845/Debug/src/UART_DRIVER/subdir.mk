...
CPP_SRCS += \
../src/UART_DRIVER/UART0.cpp 

CPP_DEPS += \
./src/UART_DRIVER/UART0.d 

OBJS += \
./src/UART_DRIVER/UART0.o 


# Each subdirectory must supply rules for building sources it contributes
src/UART_DRIVER/%.o: ../src/UART_DRIVER/%.cpp src/UART_DRIVER/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-UART_DRIVER

clean-src-2f-UART_DRIVER:
	-$(RM) ./src/UART_DRIVER/UART0.d ./src/UART_DRIVER/UART0.o

.PHONY: clean-src-2f-UART_DRIVER
